...
namespace WindowsFormsApplication1
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            else if (comboBox3.Text=="Onaylandı")
            {
                comboBox3.BackColor = System.Drawing.Color.Orange;
            }
            else if (comboBox3.Text == "Onaylanmadı")
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "Update staj_bilgileri set isyeri_ad='" + textBox2.Text + "',sahibi='" + textBox3.Text + "',isyeri_yetkilisi='" + textBox4.Text + "',is_telefon='" + textBox5.Text + "',e_mail='" + textBox6.Text + "',isyeri_adresi='" + textBox7.Text + "',il='" + comboBox1.Text + "',ilçe='" + comboBox2.Text + "',ogrenci_gmail='" + textBox8.Text + "',koordinator_ogrt='" + textBox9.Text + "',staj_kabul='" + comboBox3.Text + "' where ıd=" + textBox1.Text + "";
